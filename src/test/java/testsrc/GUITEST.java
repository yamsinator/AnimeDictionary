...
public class GUITEST {
	...
	public GUITEST() {
		frame = new JFrame("Anime APITEST");
		...
		searchButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!searchTerm.isEmpty()) {
					...
					// Call APITEST to search based on selected type
					List<JSONObject> searchResults;
					switch (selectedType) {
					case "Anime":
						searchResults = APITEST.searchAnimeByName(searchTerm);
						break;
					case "Manga":
						searchResults = APITEST.searchMangaByName(searchTerm);
						break;
					case "Characters":
						searchResults = APITEST.searchCharactersByName(searchTerm);
						break;
					default:
